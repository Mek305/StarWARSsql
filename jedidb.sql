...
INSERT INTO jedis (name, lightsaber_color, years_training, tempted_by_dark_side, temptation) VALUES
 ...
 SELECT * FROM jedi WHERE lightsaber_color ='red';


 SELECT * FROM jedis WHERE tempted_by_dark_side = true;
 ...
 SELECT lightsaber_color FROM jedis WHERE years_training < 8 AND tempted_by_dark_side = false;
 ...
 SELECT SUM(years_training)FROM jedis WHERE tempted_by_dark_side = false AND lightsaber_color = 'purple';
